...
//            
//            NSLayoutConstraint.activate([
//                saveButton.centerXAnchor.constraint(equalTo: cell.contentView.centerXAnchor),
//                saveButton.centerYAnchor.constraint(equalTo: cell.centerYAnchor),
...
class ResultViewController: UITableViewController {
    ...
    @objc private func saveTapped() {
        ...
        // 디버깅 메시지 추가
        print("Saved Result - Image size: \(selectedImage.size), Total Amount: \(totalPrice), Date: \(Date())")
    }
}
